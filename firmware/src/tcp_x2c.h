...
typedef enum
{
	...
	TCP_X2C_STATE_INIT=0,
	TCP_X2C_STATE_SERVICE_TASKS,

	/* TODO: Define states used by the application state machine. */
    TCP_X2C_STATE_WAIT_FOR_IP,

    TCP_X2C_STATE_OPENING_SERVER,

    TCP_X2C_STATE_WAIT_FOR_CONNECTION,

    TCP_X2C_STATE_SERVING_CONNECTION,

    TCP_X2C_STATE_CLOSING_CONNECTION,
...
struct tTcpIp {
	uint8_t (*send)(tTcpIp*, uint8_t);
	uint8_t (*receive)(tTcpIp*);
	uint8_t (*isReceiveDataAvailable)(tTcpIp*);
	uint8_t (*isSendReady)(tTcpIp*);
	uint8_t (*getTxFifoFree)(tTcpIp*);
	void (*flush)(tTcpIp*);
